...
<script type="text/javascript">
  ...
  function createTblRow(dataRow) {
    ...
    // span1.textContent = dataRow["categ_id"];
    ...
    btnDelt.className = "tbl_btn_delt btn-sm red mr-md-2";
    btnDelt.title = "Delete Category";
    btnDelt.onclick = deltCategoryLoader;
    tblData4.appendChild(btnDelt);
