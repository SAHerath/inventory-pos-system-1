...
<script type="text/javascript">
  ...
  let dataList = new DataList(`${urlroot}getDetails`, displayData);
  ...
  function printData() {
    ...
    location.href = urlroot + "print/new/" + settings[0] + "/" + settings[1] + "/" + settings[2];
  }
</script>
