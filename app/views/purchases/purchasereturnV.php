...
<main class="main" id="main">
  ...
  <div class="main-cards">
    <div class="card">
      <form id="rtn_purch" name="rtn_purch" novalidate autocomplete="off">
        <span id="rtn_purch_msg" class="status" aria-live="polite"></span>
        ...
        <div class="row pb-2 pb-sm-2">
          <div class="col col-sm-6 pr-sm-3">
            ...
            <div class="row pb-2 pb-sm-3">
              ...
              <input class="" id="purch_retrn_date" name="purch_retrn_date" type="date" placeholder="" required value="<?php echo $data['date']; ?>">
            </div>
          </div>
          <div class="col col-sm-6 pl-sm-3">
            <!-- <div class="row pb-2 pb-sm-3">
          ...
          <div class="table">
            <div class="thead">
              <div class="tr">
                ...
                <div class="th" title="Return Quantity" style="width: 100px;">Ret. Qty</div>
            ...
            <div class="tbody stripes" id="dl_tbl_body">
              ...
              <?php foreach ($data['ordprd'] as $id => $row) : ?>
                <div class="tr" id="tblr_<?php echo $id + 1; ?>">
                  ...
                  <div class="td">
                    <!-- received qty -->
                    <input id="tblr_<?php echo $id + 1; ?>_purch_rec" type="number" disabled value="<?php echo $row['pcpd_recev_qty']; ?>">
                  </div>
                  <div class="td">
                    <!-- return qty -->
                    <input id="tblr_<?php echo $id + 1; ?>_purch_ret" type="number" value="0" max="<?php echo $row['pcpd_recev_qty']; ?>" min="0">
                  </div>
                  <div class="td">
...
<script type="text/javascript">
  ...
  function updateRowTbl(rowId) {
    let inpQtyVal = document.getElementById(rowId + "_purch_ret").value;
  ...
  function addEvents() {
    for (let ind = 1; ind < tblRowCount; ind++) {
      ...
      let inpQty = document.getElementById("tblr_" + ind + "_purch_ret");
  ...
  function purchaseReturned() {
    console.log("purchaseReturned");
    location.href = urlroot;
  }

  let rtnOrder = new FormHandler('rtn_purch', 'rtn_purch_msg', `${urlroot}returnPurchase`);
  rtnOrder.setCallback(purchaseReturned);
</script>
