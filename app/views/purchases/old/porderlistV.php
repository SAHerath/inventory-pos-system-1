...
<main class="main" id="main">
  ...
  <div class="main-cards">
    <div class="row mb-2">
      <a class="btn blue" href="<?php echo URLROOT; ?>purchases/add" tabindex="0">Add New Purchase Order</a>
    </div>
    <div class="card">
        ...
        <div class="table-wrap">
          ...
          <div class="table">
            ...
            <div class="tbody" id="dl_tbl_body">
              <div class="tr">
                <div class="td"><span>PO-0000002</span></div>
...
<script type="text/javascript">
  ...
  function createTblRow(dataRow) {
    ...
    tblRow.className = "tr";
    tblRow.dataset.rowId = dataRow["purch_id"];
    ...
    span1.textContent = dataRow["purch_no"];
    ...
    span2.textContent = dataRow["purch_date"];
    ...
    span3.textContent = dataRow["vendr_name"];
    ...
    span4.textContent = dataRow["purch_state"];
